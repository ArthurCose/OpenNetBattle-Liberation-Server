...
encounters_table["default"] = {
  min_travel = 10, -- n tiles are free to walk after each encounter
  chance = .025, -- chance for each movement event after the minimum travel to cause an encounter
  preload = true,
  encounters = {
    {
      asset_path = "/server/assets/encounters/acdc2.zip",
      weight = 0.1
    }
  }
}
